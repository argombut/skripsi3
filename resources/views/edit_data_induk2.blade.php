                                ...
                                <div class="row form-group">
                                    ...
                                    <div class="col-12 col-md-9">
                                        <div class="container text-center">
                                            <div class="row">
                                                <div class="col">
                                                    <input type="checkbox" id="is_latin" {{ 'Ya'== $edit->is_latin ? 'checked' : ''}}>
                                                    <label for="is_latin">Baca Latin</label>
                                                </div>
                                                <div class="col">
                                                    <input type="checkbox" id="is_hijaiyah" {{ 'Ya'== $edit->is_hijaiyah ? 'checked' : ''}}>
                                                    <label for="is_hijaiyah">Baca Hijaiyah</label>
                                                </div>
                                                <div class="col">
                                                    <input type="checkbox" id="is_iqra" {{ 'Ya'== $edit->is_iqra ? 'checked' : ''}}>
                                                    <label for="is_iqra">Baca Iqra</label>
                                                </div>
                                                <div class="col">
                                                    <input type="checkbox" id="is_quran" {{ 'Ya'== $edit->is_quran ? 'checked' : ''}}>
                                                    <label for="is_quran">Baca Al-Qur'an</label>
                                                </div>
                                                <div class="col">
                                                    <input type="checkbox" id="is_5waktu" {{ 'Ya'== $edit->is_5waktu ? 'checked' : ''}}>
                                                    <label for="is_5waktu">Sholat 5 Waktu</label>
                                                </div>
                                                <div class="col">
                                                    <input type="checkbox" id="is_jamaah" {{ 'Ya'== $edit->is_jamaah ? 'checked' : ''}}>
                                                    <label for="is_jamaah">Sholat Berjamaah</label>
                                                </div>
