                ...
                <div class="sidebar-content">
                    ...
                    <div class="sidebar-menu">
                        <ul>
                            ...
                            <li class="{{ '/red_pkk'    == $InfoPage['Navbar'] ? 'active' : ''}}">
                                <a href="{{ url ('/red_pkk')}}">
                                ...
                                <div class="sidebar-submenu">
                                    <ul>
                                        <li class="{{ '/red_pkk/warga'    == $InfoPage['Navbar'] ? 'active' : ''}}">
                                            <a href="{{ url ('/red_pkk/warga')}}" style="color: white">Warga Perempuan</a>
                                        </li>
                                        ...
                                        <li class="{{ '/red_pkk/pekerjaan' == $InfoPage['Navbar'] ? 'active' : ''}}">
                                            <a href="{{ url ('/red_pkk/pekerjaan')}}" style="color: white">Pekerjaan</a>
                                        </li>
                                        <li class="{{ '/red_pkk/keahlian' == $InfoPage['Navbar'] ? 'active' : ''}}">
                                            <a href="{{ url ('/red_pkk/keahlian')}}" style="color: white">Keahlian</a>
                                        </li>
                                    </ul>
                                </div>
                            </li>
