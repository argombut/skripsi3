                ...
                <div class="sidebar-content">
                    ...
                    <div class="sidebar-menu">
                        <ul>
                            ...
                            <li class="{{ '/red_rw'    == $InfoPage['Navbar'] ? 'active' : ''}}">
                                <a href="{{ url ('/red_rw')}}">
                                ...
                                <div class="sidebar-submenu">
                                    <ul>
                                        <li class="{{ '/red_rw/warga'    == $InfoPage['Navbar'] ? 'active' : ''}}">
                                            <a href="{{ url ('/red_rw/warga')}}" style="color : white">Data Warga</a>
                                        </li>
                                        <li class="{{ '/red_rw/datakk' == $InfoPage['Navbar'] ? 'active' : ''}}">
                                            <a href="{{ url ('/red_rw/datakk')}}" style="color : white">Data Kartu Keluarga</a>
                                        </li>
                                        <li class="{{ '/red_rw/agama' == $InfoPage['Navbar'] ? 'active' : ''}}">
                                            <a href="{{ url ('/red_rw/agama')}}" style="color : white">Data Ibadah</a>
                                        </li>
                                        <li class="{{ '/red_rw/keahlian' == $InfoPage['Navbar'] ? 'active' : ''}}">
                                            <a href="{{ url ('/red_rw/keahlian')}}" style="color : white">Data Keahlian</a>
                                        </li>
                                        <li class="{{ '/red_rw/gol_darah' == $InfoPage['Navbar'] ? 'active' : ''}}">
                                            <a href="{{ url ('/red_rw/gol_darah')}}" style="color : white">Data Golongan Darah</a>
                                        </li>
                                        <li class="{{ '/red_rw/ekonomi' == $InfoPage['Navbar'] ? 'active' : ''}}">
                                            <a href="{{ url ('/red_rw/ekonomi')}}" style="color : white">Data Level Ekonomi</a>
                                        </li>
                                        <li class="{{ '/red_rw/pekerjaan' == $InfoPage['Navbar'] ? 'active' : ''}}">
                                            <a href="{{ url ('/red_rw/pekerjaan')}}" style="color : white">Data Pekerjaan Warga</a>
                                        </li>
                                        <li class="{{ '/red_rw/pendidikan' == $InfoPage['Navbar'] ? 'active' : ''}}">
                                            <a href="{{ url ('/red_rw/pendidikan')}}" style="color : white">Data Pendidikan</a>
                                        </li>
