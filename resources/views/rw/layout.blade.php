                ...
                <div class="sidebar-content">
                    ...
                    <div class="sidebar-menu">
                        <ul>
                            ...
                            <li class="{{ '/rw'    == $InfoPage['Navbar'] ? 'active' : ''}}">
                                <a href="{{ url ('/rw')}}">
                                ...
                                <div class="sidebar-submenu">
                                    <ul>
                                        <li class="{{ '/rw/warga'    == $InfoPage['Navbar'] ? 'active' : ''}}">
                                            <a href="{{ url ('/rw/warga')}}" style="color : white">Data Warga</a>
                                        </li>
                                        <li class="{{ '/rw/datakk' == $InfoPage['Navbar'] ? 'active' : ''}}">
                                            <a href="{{ url ('/rw/datakk')}}" style="color : white">Data Kartu Keluarga</a>
                                        </li>
                                        <li class="{{ '/rw/agama' == $InfoPage['Navbar'] ? 'active' : ''}}">
                                            <a href="{{ url ('/rw/agama')}}" style="color : white">Data Ibadah</a>
                                        </li>
                                        <li class="{{ '/rw/keahlian' == $InfoPage['Navbar'] ? 'active' : ''}}">
                                            <a href="{{ url ('/rw/keahlian')}}" style="color : white">Data Keahlian</a>
                                        </li>
                                        <li class="{{ '/rw/gol_darah' == $InfoPage['Navbar'] ? 'active' : ''}}">
                                            <a href="{{ url ('/rw/gol_darah')}}" style="color : white">Data Golongan Darah</a>
                                        </li>
                                        <li class="{{ '/rw/ekonomi' == $InfoPage['Navbar'] ? 'active' : ''}}">
                                            <a href="{{ url ('/rw/ekonomi')}}" style="color : white">Data Level Ekonomi</a>
                                        </li>
                                        <li class="{{ '/rw/pekerjaan' == $InfoPage['Navbar'] ? 'active' : ''}}">
                                            <a href="{{ url ('/rw/pekerjaan')}}" style="color : white">Data Pekerjaan Warga</a>
                                        </li>
                                        <li class="{{ '/rw/pendidikan' == $InfoPage['Navbar'] ? 'active' : ''}}">
                                            <a href="{{ url ('/rw/pendidikan')}}" style="color : white">Data Pendidikan</a>
                                        </li>
